...
the read-time vocabulary corpus-wide. Planning [011](../tickets/01-0120-twc-provider.md) against real
...
- **TWC: duration is offering *identity*, cadence is offering *policy*** — name against a catalogue row
  (boot-checked), settings for the knob → [ticket 011](../tickets/01-0120-twc-provider.md).
