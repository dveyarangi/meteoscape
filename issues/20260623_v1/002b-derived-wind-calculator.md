...
[ADR-0005](../../docs/adr/0005-build-time-composition.md)) with **memoization** (one node per derived
...
degree average — [concern #5](../../docs/concerns.md#5-read-time-homogenization-fidelity)). See
`docs/v1-requirements.md` (Parameters) and
[ADR-0004](../../docs/adr/0004-producer-resolution-and-capability.md) (Calculators).
