...
| 0126 | [Tick-convention declaration](./01-0126-tick-convention-declaration.md) | — | Planned (own align precedes) | TWC provider (the second convention) | A tap declares where its value sits relative to the tick, repairing Open-Meteo's live precipitation hour-label error → [#48](../concerns.md#48-a-tap-cannot-declare-where-its-value-sits-relative-to-the-tick). |
