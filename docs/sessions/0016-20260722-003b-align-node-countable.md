...
An align session over [003b](../tickets/done/01-0060-capability-domain.md)'s five open placement questions.
All five resolved (recorded inline in the ticket); two side-finds outgrew the ticket — a new
maintenance ticket [m2](../tickets/done/01-0070-dissolve-node-countable.md) and the discovery that
...
**Node-`Countable` dissolves → [m2](../tickets/done/01-0070-dissolve-node-countable.md).** Started as a
...
- **Then [m2](../tickets/done/01-0070-dissolve-node-countable.md) before [006](../tickets/01-0130-retentive-store-freshness.md)** —
