...
4. **The leaf serves one snapped placement — and it *declares* that, rather than guarding it.**
   ...
   helper exists, and [011](../../tickets/done/01-0120-twc-provider.md)'s second provider inherits
...
native records into one answer, [011](../../tickets/done/01-0120-twc-provider.md)'s second provider
