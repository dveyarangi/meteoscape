...
- **T** — Enumerable is the v1 path; **Snapped-T** is the window-fitting mode — a live rolling window whose servable edge the caller cannot know, and equally an archive's retention edge later → [m4](./tickets/m4-snapped-t-request-mode.md), [003c](./tickets/003c-request-shaping.md).
