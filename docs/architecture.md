...
the Arbiter folds is already conformable. Holding shape, `quantize`, and the two reshapes are owned by
...
implementations vary by substrate, persistence, and lattice structure behind one write/read face. Its
