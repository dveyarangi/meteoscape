...
| 0115.0020 | [Multi-domain carrier and timeline rework](./01-0115.0020-multidomain-carrier-timeline.md) | — | Ready | `ANY` boundless member, per-parameter materialized capability | Carrier minted; `agreed_geometries` returns a group; both eager folds retired; natural fetch unit. No behavior change. |
