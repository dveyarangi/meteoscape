...
(`ParameterId → ParameterDef`), `ProviderCatalog` (`impl_id → ProviderManifest`), `DerivationCatalog`
(`fn_id → DerivationManifest`). They carry vocabulary + cohesive plugin faces (declarations *and*
