...
- **`StubStore`** lives in `nodes/store.py` beside the `Store` protocol — weave-time placeholder (no
  ...
  [issue 006](../../../tickets/done/01-0115-retentive-store-freshness.md).
...
- Store-grid representation decision → [issue 006](../../../tickets/done/01-0115-retentive-store-freshness.md).
