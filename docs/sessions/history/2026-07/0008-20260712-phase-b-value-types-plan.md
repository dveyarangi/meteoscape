...
Continues session 0007 (Phase A landed). Grilled Phase B of
[issue 001](../../../tickets/done/01-0020-walking-skeleton.md) — the six runtime stubs in
...
- **`Axis.extent` = the tick span** `[anchor, anchor + (count−1)·step]`, uniformly — `cellular`
  ...
  padded nodata cell. Filed on [issue 002](../../../tickets/done/01-0030-core-5-parameters.md) with
...
- Phase C (the spine) per [issue 001](../../../tickets/done/01-0020-walking-skeleton.md).
- Extensive `serves` edge → [issue 002](../../../tickets/done/01-0030-core-5-parameters.md);
